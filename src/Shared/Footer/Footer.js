              ...
              <div className="md:max-w-md lg:col-span-2">
                ...
                <div className="mt-4 lg:max-w-sm">
                  <p className="text-sm text-deep-purple-50">
                    How to send your information to Companies House using our
                    online services. ... You'll need to 'Create an account' for
                    the Companies House WebFiling service.
                  </p>
                  <p className="mt-4 text-sm text-deep-purple-50">
                    In order to register for online WebFiling, you must register
                    with Companies House and choose a password. Companies House
                    will then send an authentication code ...
                  </p>
                </div>
              </div>
