	...
	<div className="container flex flex-col justify-center p-4 mx-auto md:p-8">
		...
		<div className="grid gap-10 md:gap-8 sm:p-3 md:grid-cols-2 lg:px-12 xl:px-32">
			<div>
				...
				<p className="mt-1 text-gray-600">Global state is necessary when we want to get and update data anywhere in our app, or in multiple components at least.
