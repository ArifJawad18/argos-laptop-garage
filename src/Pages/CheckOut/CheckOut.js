...
const CheckOut = () => {
  ...
  const handlePlaceOrder = (event) => {
    ...
    fetch("https://argos-laptop-garage-server.vercel.app/orders", {
      method: "POST",
      headers: {
      ...
      <section className="p-6 text-gray-800">
        ...
        >
          ...
          <div>
            <button
              type="submit"
              className="w-full px-4 py-2 font-bold rounded shadow focus:outline-none focus:ring hover:ring focus:ring-opacity-50 bg-sky-600 focus:ring-sky-600 hover:ring-sky-600 text-gray-50"
            >
              Submit
            </button>
          </div>
