...
const Customer = () => {
  return (
    <div>
          ...
          <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20 dark:bg-gray-800 dark:text-gray-100">
            ...
            <ul className="grid gap-3 md:grid-cols-2 lg:grid-cols-3">
              ...
              <li className="flex items-center space-x-2">
                ...
                <span>First Time Shipping Free</span>
              </li>
              <li className="flex items-center space-x-2">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <li className="flex items-center space-x-2">
                ...
                <span>Offer Styles for Every Body.</span>
              </li>
              <li className="flex items-center space-x-2">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                ...
                <span> Find the Perfect Laptop </span>
              </li>
            </ul>
          </div>
        </section>
      ...
      <div>
        <div className="mx-5">
          <section className="p-6 my-6 bg-gray-800 text-gray-600">
            <div className="container grid grid-cols-1 gap-6 mx-auto sm:grid-cols-2 xl:grid-cols-4">
              <div className="flex p-4 space-x-4 rounded-lg md:space-x-6 bg-gray-800 text-gray-100">
      ...
      <div>
        <section className="mt-8">
          <div className="container mx-auto flex flex-col items-center pb-6 mb-4 md:p-10 md:px-12">
            <h1 className="text-4xl font-semibold leading-none text-center text-white">
          ...
          <div className="container mx-auto grid grid-cols-1 gap-8 lg:gap-20 md:px-10 md:pb-10 lg:grid-cols-2">
            <div className="flex flex-col items-center mx-12 lg:mx-0">
              <div className="relative text-center">
                ...
                <p className="px-6 py-1 text-lg italic text-yellow-200">
              ...
              <p className="text-white">Thompson Joy</p>
            </div>
          ...
          <div className="container flex flex-col items-center justify-center p-4 mx-auto space-y-8 sm:p-10">
            ...
            <div className="flex flex-row flex-wrap-reverse justify-center">
              <div className="flex flex-col justify-center m-8 text-center">
                ...
                />
                <p className="text-xl font-semibold leading-tight">Jen Roy </p>
                <p className="dark:text-gray-400">CEO and Founder</p>
              </div>
              ...
              <div className="flex flex-col justify-center m-8 text-center">
                ...
                />
                <p className="text-xl font-semibold leading-tight">Joyce</p>
                <p className="dark:text-gray-400">Marketing Executive</p>
              </div>
              <div className="flex flex-col justify-center m-8 text-center">
                <img
                  alt=""
                ...
                <p className="dark:text-gray-400">Sales Force Expert</p>
              </div>
              <div className="flex flex-col justify-center m-8 text-center">
                <img
                  alt=""
                ...
                />
                <p className="text-xl font-semibold leading-tight">Leroy</p>
                <p className="dark:text-gray-400">Delivery Hero</p>
              </div>
            </div>
          </div>
        </section>
      ...
      <div>
        <section className="p-6 dark:bg-gray-800 dark:text-gray-100 mt-8">
          ...
          <div className="container flex flex-wrap justify-center mx-auto dark:text-white-400">
